...
var API = /** @class */ (function () {
    ...
    API.prototype.createUser = function (usuarioDTO) {
        var usuario = Usuario_1.Usuario.CrearUsuario(usuarioDTO.getNombre(), usuarioDTO.getApellido(), usuarioDTO.getEmail(), usuarioDTO.getPassword(), usuarioDTO.getConfirmPassword());
